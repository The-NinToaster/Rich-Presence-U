...
//Status predefinidos
ini_open(folder+"status.ini");
status_1p = ini_read_string("RPU_STATUS","SINGLPLAYER","Single Player");
status_2p = ini_read_string("RPU_STATUS","MULTIPLAYER","Multiplayer");
status_on = ini_read_string("RPU_STATUS","ONLINE"," (Online)");
ini_close();
